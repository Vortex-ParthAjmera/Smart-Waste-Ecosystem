...
import { Truck as TruckIcon, Clock } from "lucide-react";
...
export default function CitizenTruckPreviewPage() {
  ...
  return (
    <div className="space-y-3">
      <PageHeader title="Truck & ETA" description="Estimated collection schedule for your area" />
      <div className="flex items-center gap-2 rounded-xl bg-brand-primary-light px-3 py-2 text-xs text-brand-primary-dark">
        <Clock className="h-4 w-4 shrink-0" />
        <span>Live GPS tracking integration in progress — ETA shown is estimated based on route schedule.</span>
      </div>
      <Card>
        <CardContent className="space-y-4 p-4">
          ...
          <div>
            <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-brand-muted-fg">Collection progress</p>
