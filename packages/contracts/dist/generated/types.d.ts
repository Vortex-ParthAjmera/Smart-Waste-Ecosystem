...
export type ProcessingState = "DISPOSAL_STARTED" | "SENSOR_CAPTURED" | "ML_PENDING" | "ML_RECEIVED" | "ML_UNAVAILABLE" | "PROCESSING" | "SEGREGATION_DECIDED" | "POINTS_CALCULATED" | "REVIEW_REQUIRED" | "COMPLETED" | "PROCESSING_FAILED";
export type DecisionState = "CAPTURED" | "EVALUATING" | "ACCEPTED" | "FLAGGED" | "REVIEW_ACCEPTED" | "REVIEW_NO_ACTION" | "VERIFIED_VIOLATION" | "PENALIZED" | "CLOSED";
